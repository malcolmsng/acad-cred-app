...
contract('Unit Test', function (accounts) {
  ...
  it('Check approved status', async () => {
    // Open vote
    let app_paid = await acceptanceVotingInstance.payFee(1, accounts[9], { from: accounts[9], value: oneEth.multipliedBy(5) });
  ...
  it('Check distribute fee', async () => {
    ...
    await acceptanceVotingInstance.payFee(2, accounts[5], { from: accounts[5], value: 5e18 });
  ...
  it('View Credential by Id', async () => {
    ...
    let credentialView = await credentialInstance.viewCredentialById(3, { from: accounts[1] });
